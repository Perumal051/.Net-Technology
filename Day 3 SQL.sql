...
--Q3
SELECT id,street_address,city,state FROM location ORDER BY id ASC;

--Q14
SELECT first_name from employee where id in(SELECT employee_id from manager where department_id=
...
--Q9
SELECT name FROM Countries where region_id in (SELECT id FROM Region where name='europe') ORDER BY name ASC

--Q3
SELECT first_name from employee where id in(SELECT employee_id from manager where department_id=
(select id from department where name='accounts')) ORDER BY first_name ASC;
--
--Q7
select name,count(id)from department group by name